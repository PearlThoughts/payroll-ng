...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["layout-layout-module"], {
  ...
  function srcAppLayoutComponentsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])], HeaderComponent);
    /***/
  },
  ...
  function srcAppLayoutComponentsSidebarSidebarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function SidebarComponent(translate, router, authService) {
        ...
        this.router.events.subscribe(function (val) {
          if (val instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"] && window.innerWidth <= 992 && _this2.isToggled()) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], SidebarComponent.prototype, "collapsedEvent", void 0);
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])], SidebarComponent);
    /***/
  },
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          [__webpack_require__.e("common"), __webpack_require__.e("employee-employee-module")]).then(__webpack_require__.bind(null,
          /*! ./employee/employee.module */
          "./src/app/layout/employee/employee.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | leaves-leave-module */
          [__webpack_require__.e("default~beneficiary-beneficiary-module~leaves-leave-module~transfer-transfer-module"), __webpack_require__.e("common"), __webpack_require__.e("leaves-leave-module")]).then(__webpack_require__.bind(null,
          /*! ./leaves/leave.module */
          "./src/app/layout/leaves/leave.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | salary-salary-module */
          [__webpack_require__.e("common"), __webpack_require__.e("salary-salary-module")]).then(__webpack_require__.bind(null,
          /*! ./salary/salary.module */
          "./src/app/layout/salary/salary.module.ts")).then(function (m) {
            return m.SalaryModule;
          });
        }
      }, {
        path: "transfer",
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | transfer-transfer-module */
          [__webpack_require__.e("default~beneficiary-beneficiary-module~leaves-leave-module~transfer-transfer-module"), __webpack_require__.e("common"), __webpack_require__.e("transfer-transfer-module")]).then(__webpack_require__.bind(null,
          /*! ./transfer/transfer.module */
          "./src/app/layout/transfer/transfer.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | beneficiary-beneficiary-module */
          [__webpack_require__.e("default~beneficiary-beneficiary-module~leaves-leave-module~transfer-transfer-module"), __webpack_require__.e("beneficiary-beneficiary-module")]).then(__webpack_require__.bind(null,
          /*! ./beneficiary/beneficiary.module */
          "./src/app/layout/beneficiary/beneficiary.module.ts")).then(function (m) {
            return m.BeneficiaryModule;
          });
        }
      }]
    }];
  ...
  function srcAppLayoutLayoutComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(LayoutComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authStatusSub = this.authService.getAuthStatusListener().subscribe(function (isAuthenticated) {
            _this3.userIsAuthenticated = isAuthenticated;
            _this3.userId = _this3.authService.getUserId();
          });
        }
      }, {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], LayoutComponent);
    /***/
  },
  ...
  function srcAppLayoutLayoutModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LayoutModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _layout_routing_module__WEBPACK_IMPORTED_MODULE_5__["LayoutRoutingModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbDropdownModule"]],
