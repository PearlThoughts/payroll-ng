...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BeneficiaryRoutingModule", function() { return BeneficiaryRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _beneficiary_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./beneficiary.component */ "./src/app/layout/beneficiary/beneficiary.component.ts");
...
let BeneficiaryRoutingModule = class BeneficiaryRoutingModule {
};
BeneficiaryRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var src_app_shared_services_benefiaciary_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/services/benefiaciary.service */ "./src/app/shared/services/benefiaciary.service.ts");
/* harmony import */ var _info_info_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./info/info.component */ "./src/app/layout/beneficiary/info/info.component.ts");
...
let BeneficiaryComponent = class BeneficiaryComponent {
    constructor(dialogService, beneficiaryService) {
        this.dialogService = dialogService;
        this.beneficiaryService = beneficiaryService;
    }
    ngOnInit() {
        this.beneficiaryService.get().subscribe(() => { });
        this.beneficiaryService.getBeneficiariesData().subscribe((data) => {
...
BeneficiaryComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
    { type: src_app_shared_services_benefiaciary_service__WEBPACK_IMPORTED_MODULE_4__["BeneficiaryService"] }
];
BeneficiaryComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-beneficiary",
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./beneficiary.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/beneficiary/beneficiary.component.html")).default,
        animations: [Object(_router_animations__WEBPACK_IMPORTED_MODULE_2__["routerTransition"])()],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./beneficiary.component.scss */ "./src/app/layout/beneficiary/beneficiary.component.scss")).default]
    }),
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"],
        src_app_shared_services_benefiaciary_service__WEBPACK_IMPORTED_MODULE_4__["BeneficiaryService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BeneficiaryModule", function() { return BeneficiaryModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _beneficiary_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./beneficiary-routing.module */ "./src/app/layout/beneficiary/beneficiary-routing.module.ts");
/* harmony import */ var _beneficiary_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./beneficiary.component */ "./src/app/layout/beneficiary/beneficiary.component.ts");
...
BeneficiaryModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _beneficiary_routing_module__WEBPACK_IMPORTED_MODULE_3__["BeneficiaryRoutingModule"],
...
let InfoComponent = class InfoComponent {
    constructor(modal, beneficiaryService) {
        this.modal = modal;
        this.beneficiaryService = beneficiaryService;
        this.beneficiary = {};
    }
    ngOnInit() {
        this.beneficiaryService.findById(this.beneId).subscribe((data) => {
...
InfoComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./info.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/beneficiary/info/info.component.html")).default,
        animations: [Object(_router_animations__WEBPACK_IMPORTED_MODULE_2__["routerTransition"])()],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./info.component.scss */ "./src/app/layout/beneficiary/info/info.component.scss")).default]
    }),
...
let BeneficiaryService = class BeneficiaryService {
    ...
    get() {
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/api/beneficiary`, this.options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((transfers) => {
            this.beneficiaries.next(transfers);
            return transfers;
        }));
    }
    findById(beneficiary_id) {
        return this.http
            .get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/api/beneficiary/${beneficiary_id}`, this.options)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((beneficiary) => {
...
//# sourceMappingURL=beneficiary-beneficiary-module-es2015.js.map